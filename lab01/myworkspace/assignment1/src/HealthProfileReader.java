...
public class HealthProfileReader {
	...
	public static void main(String[] args) {
		...
		if (argCount == 0) {
			...
			System.out.println("Are you sure you gave me last and first names");
		} else if (argCount == 2) {
			String fname = args[0];
			String lname = args[1];
        ...
        //homework classes
        private static void createPerson(String firstname, String lastname, Date birthdate)
        {
        ...
        private static void displayHealthProfile(Long personID) 
        {
           Person p= database.get(personID);
			if (p!=null) { 
				System.out.println(personID + "'s health profile is: "+p.gethProfile().toString());
			} else {
